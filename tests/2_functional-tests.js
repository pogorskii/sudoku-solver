...
suite("Functional Tests", () => {
  ...
  test("Check a puzzle placement with incorrect length: POST request to /api/check", (done) => {
    chai
      ...
      .send({
        puzzle:
          "1.5..2.84..63.12.7.2..5..h..9..1..8.2.3674.3.7.2..9.47...8..1..16....92693333314.37.",
        coordinate: "A2",
        value: "3",
      })
      .end((err, res) => {
  ...
  test("Check a puzzle placement with invalid placement coordinate: POST request to /api/check", (done) => {
    chai
      ...
      .keepOpen()
      .post("/api/check")
      .send({ puzzle: validPuzzle, coordinate: "L22", value: "3" })
      .end((err, res) => {
        assert.equal(res.status, 200);
  ...
  test("Check a puzzle placement with invalid placement value: POST request to /api/check", (done) => {
    chai
      ...
      .keepOpen()
      .post("/api/check")
      .send({ puzzle: validPuzzle, coordinate: "A2", value: "W" })
      .end((err, res) => {
        assert.equal(res.status, 200);
        assert.equal(
          res.body.error,
          "Invalid value" || "Invalid characters in puzzle"
        );
        done();
      });
  });
